...
namespace MicroDemo.Application.Features.Orders.Dtos;

/// <summary>Projeção de leitura de <see cref="Order"/>, incluindo as suas linhas.</summary>
...
/// <summary>Projeção de leitura de uma linha de pedido (<see cref="OrderItem"/>).</summary>
